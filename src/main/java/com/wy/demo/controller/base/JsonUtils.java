...
import com.wy.demo.util.DateJsonValueProcessor;
import com.wy.demo.util.DateUtils;
import com.wy.demo.util.MyDateMorpher;
import com.wy.demo.util.StringUtils;
import net.sf.json.*;
...
public class JsonUtils {
	...
	public static Object getObject4JsonObject(JSONObject jsonObject, Class pojoCalss, String format) {
		...
		if(format == null){
			format = com.wy.demo.util.JsonUtils.LONG_DATE_PATTERN;
		}
